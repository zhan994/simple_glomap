#ifndef SCENE_IMAGE_PAIR_H
#define SCENE_IMAGE_PAIR_H
...
struct ImagePair {
  ...
  ImagePair(image_t img_id1, image_t img_id2, Rigid3d pose_rel = Rigid3d())
      : pair_id(ImagePairToPairId(img_id1, img_id2)), image_id1(img_id1),
        image_id2(img_id2), cam2_from_cam1(pose_rel) {}
