#ifndef ESTIMATORS_GRAVITY_REFINEMENT_H
#define ESTIMATORS_GRAVITY_REFINEMENT_H
...
private:
  void
  IdentifyErrorProneGravity(const ViewGraph &view_graph,
...
#endif // ESTIMATORS_GRAVITY_REFINEMENT_H