#ifndef ESTIMATORS_BUNDLE_ADJUSTMENT_H
#define ESTIMATORS_BUNDLE_ADJUSTMENT_H
...
private:
  ...
  void
  AddPointToCameraConstraints(const ViewGraph &view_graph,
                              std::unordered_map<camera_t, Camera> &cameras,
                              std::unordered_map<image_t, Image> &images,
                              std::unordered_map<track_t, Track> &tracks);
...
#endif // ESTIMATORS_BUNDLE_ADJUSTMENT_H