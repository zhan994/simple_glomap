#ifndef ESTIMATORS_GLOBAL_ROTATION_AVERAGING_H
#define ESTIMATORS_GLOBAL_ROTATION_AVERAGING_H
...
protected:
  ...
  void
  InitializeFromMaximumSpanningTree(const ViewGraph &view_graph,
                                    std::unordered_map<image_t, Image> &images);
  ...
  // rotation magnitudes.
  double
  ComputeAverageStepSize(const std::unordered_map<image_t, Image> &images);
...
#endif // ESTIMATORS_GLOBAL_ROTATION_AVERAGING_H