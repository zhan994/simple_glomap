#ifndef ESTIMATORS_GLOBAL_POSITIONING_H
#define ESTIMATORS_GLOBAL_POSITIONING_H
...
protected:
  ...
  void
  AddPointToCameraConstraints(std::unordered_map<camera_t, Camera> &cameras,
                              std::unordered_map<image_t, Image> &images,
                              std::unordered_map<track_t, Track> &tracks);
...
#endif // ESTIMATORS_GLOBAL_POSITIONING_H