#ifndef ESTIMATORS_COST_FUNCTION_H
#define ESTIMATORS_COST_FUNCTION_H
...
inline Eigen::Vector4d fetzer_d(const Eigen::Vector3d &ai,
                                ...
                                const Eigen::Vector3d &bj, const int u,
                                const int v) {
  Eigen::Vector4d d;
  d.setZero();
...
inline std::array<Eigen::Vector4d, 3>
fetzer_ds(const Eigen::Matrix3d &i1_G_i0) {
  Eigen::JacobiSVD<Eigen::Matrix3d> svd(i1_G_i0, Eigen::ComputeFullU |
                                                     Eigen::ComputeFullV);
...
public:
  ...
  static ceres::CostFunction *Create(const Eigen::Matrix3d i1_F_i0,
    ...
    return (new ceres::AutoDiffCostFunction<FetzerFocalLengthCost, 2, 1, 1>(
        new FetzerFocalLengthCost(i1_F_i0, principal_point0,
                                  principal_point1)));
  }
...
#endif // ESTIMATORS_COST_FUNCTION_H