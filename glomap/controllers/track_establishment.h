#ifndef CONTROLLERS_TRACK_ESTABLISHMENT_H
#define CONTROLLERS_TRACK_ESTABLISHMENT_H
...
class TrackEngine {
 public:
  ...
  std::size_t EstablishFullTracks(std::unordered_map<track_t, Track>& tracks);

  // Subsample the tracks, and exclude too short / long tracks
  // Return the number of tracks
  std::size_t FindTracksForProblem(
...
#endif // CONTROLLERS_TRACK_ESTABLISHMENT_H