#ifndef CONTROLLERS_GLOBAL_MAPPER_H
#define CONTROLLERS_GLOBAL_MAPPER_H
...
public:
  ...
  // api: 主求解函数
  bool Solve(const colmap::Database &database, ViewGraph &view_graph,
...
#endif // CONTROLLERS_GLOBAL_MAPPER_H