...
std::size_t TrackEngine::EstablishFullTracks(
...
void TrackEngine::TrackCollection(std::unordered_map<track_t, Track>& tracks) {
  ...
  counter = 0;
  std::size_t discarded_counter = 0;
...
std::size_t TrackEngine::FindTracksForProblem(
  ...
  std::vector<std::pair<std::size_t, track_t>> track_lengths;
